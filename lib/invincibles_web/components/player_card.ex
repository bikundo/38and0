defmodule InvinciblesWeb.Components.PlayerCard do
  ...
  def player_card(assigns) do
    ...
    >
      ...
      <div class="text-center my-2">
        ...
        <div class="text-lg font-black uppercase tracking-wide truncate max-w-full"><%= String.upcase(last_name(@player.display_name)) %></div>
      </div>
  ...
  # Helper to retrieve last name from full name
  defp last_name(display_name) do
    display_name
    |> String.split(" ")
    |> List.last()
  end
