      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-200">
          ...
          <div class="flex items-center gap-6 md:gap-10">
            ...
            <nav class="hidden md:flex items-center gap-6">
              ...
              <a
                ...
                class="text-xs font-bold uppercase tracking-[0.1em] py-4 text-[rgba(0,0,0,0.87)] hover:text-[#00754A] transition-colors"
              >
                GitHub
              </a>
            </nav>
        ...
        <nav class="flex md:hidden items-center justify-around pb-3 border-t border-[rgba(0,0,0,0.04)] pt-2 gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="text-xs font-bold uppercase tracking-[0.1em] py-2 text-[rgba(0,0,0,0.87)] hover:text-[#00754A] transition-colors"
          >
            GitHub
          </a>
        </nav>
